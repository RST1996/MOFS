<?php
	...
	if(isset($_POST['name'], $_POST['sub_type'],  $_POST['add_user']) && !empty($_POST['name']) && !empty($_POST['sub_type'])) {
       
                $name = $_POST['name'];
                $sub_type = $_POST['sub_type'];
                $insert_form = "INSERT INTO `subjects`(`id`, `sub_name`, `sub_type`, `optional_flag`, `multiple_teachers`, `form_id`) VALUES(NULL,'$name','$sub_type','0','0','0')";
